...
test('GATED_PAGES includes the homepage and three representative inner pages', () => {
  assert.equal(GATED_PAGES.length, 4);
  assert.ok(GATED_PAGES.includes('index.html'));
  assert.ok(GATED_PAGES.includes('methodology.html'));
});
