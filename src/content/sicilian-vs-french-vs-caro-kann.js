...
function render(ctx) {
  ...
  return `
    ...
    <p>None of these numbers measure how much memorization each opening demands, or how sharp/quiet the resulting positions are &mdash; both of which are usually the real deciding factor for a human choosing between them, and neither is something a database can score. The Sicilian is generally considered the most theory-heavy of the three and the Caro-Kann the least; that&rsquo;s established opening-theory consensus, not something measured on this page.</p>
