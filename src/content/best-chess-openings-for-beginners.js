...
function render(ctx) {
  ...
  return `
    ...
    <h2>Why a "score" isn't the whole story</h2>
    <p>Score here means the standard chess scoring convention (a win counts 1, a draw counts 0.5) as a percentage, for the side whose opening this is, from real games at this rating band. A high score can partly reflect that a line is comfortable and hard to go wrong in, rather than that it's objectively strongest -- which is arguably a better property for a beginner's first opening than raw engine strength would be anyway.</p>
